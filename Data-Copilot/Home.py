...
st.set_page_config(page_title="Data Copilot", page_icon="assets/images/favicon.png", layout="wide", initial_sidebar_state='collapsed')
col_main_1, col_main_2, col_main_3 = st.columns([1,5,1])

with col_main_2:
    st.markdown("# **Data Copilot - Text to Graphs/Charts**")
    st.markdown(
        """
    ...
    UPLOADED_FILE2 = st.file_uploader("Upload your data2")
...
with col_main_2:
    if not UPLOADED_FILE:
        UPLOADED_FILE = "Datasets/colleague_df.csv"
        UPLOADED_FIL2E = "Datasets/asset_df.csv"
...
@st.cache_data(show_spinner=False)
def query_text(_schema_data, new_question, _sample_data, schema_data2, sample_data2):
                ...
                if new_question not in st.session_state[index_questions]:
                    ...
                    for key in st.session_state[index_questions]:
                        if new_question == key:
                            ...
                            output, chart_recommendation, x_recommendation, y_recommendation, hue_recommendation, title_recommendation, query_recommendation, dataframe_new = query_text(schema_data, key, sample_data,
                                                                                                                                                                          schema_data2, sample_data2)
